...
if [ -z "$WEBAPP_EXISTS" ]; then
    ...
    az webapp create \
        ...
        --https-only true \
        --acr-identity "/subscriptions/9eab1979-9e75-4614-b5b7-41f9f53cac08/resourceGroups/rg_bandit_games_prod/providers/Microsoft.ManagedIdentity/userAssignedIdentities/frontend_Identity"
